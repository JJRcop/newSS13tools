...
<?php foreach ($stat->details as $c):?>
  <div class="media medal">
    <div class="media-left">
        <img class="media-object" src="<?php echo $app->APP_URL;?>icons/accessories/<?php echo $c->graphic;?>-0.png" alt="<?php echo $c->medal;?>" width="64" height="64">
    </div>
    <div class="media-body">
      <h4 class="media-heading"><?php echo $c->commendee;?></h4>
