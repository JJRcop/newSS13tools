...
<div class="page-header">
  <h1>Single statistic: <code> <?php echo $stat->name;?></code></h1>
</div>
<p class="lead">Across <?php echo $stat->rounds;?> rounds (where this statistic was tracked) between <?php echo "$stat->first and $stat->last";?>:</p>

<?php switch ($stat->name){
  case 'radio_usage':
    $radio = $stat->details;
