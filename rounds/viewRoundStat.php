...
<nav>
  ...
  <?php if ($round->prev): ?>
    <li class="previous">
        <a href='<?php echo $app->APP_URL;?>round.php?stat=<?php echo $stat->var_name;?>&round=<?php echo $round->prev;?>'>
  ...
  <?php if ($round->next): ?>
    <li class="next">
      <a href='<?php echo $app->APP_URL;?>round.php?stat=<?php echo $stat->var_name;?>&round=<?php echo $round->next;?>'>Next round
